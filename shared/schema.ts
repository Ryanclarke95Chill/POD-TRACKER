...
export const consignments = pgTable("consignments", {
  ...
  delivery_ETA: text("delivery_eta"),
  pickUp_ETA: text("pickup_eta"),
  delivery_FirstCalculatedETA: text("delivery_first_calculated_eta"),
  pickUp_FirstCalculatedETA: text("pickup_first_calculated_eta"),
